...
class MessageHandler:
    ...
    def validate_input(self, input_text):
        ...
        if len(input_text) > 1000:
            raise InputValidationError("Input is too long. Please limit your message to 1000 characters.")
        ...
        if any(char in input_text for char in disallowed_chars):
            raise InputValidationError("Input contains disallowed characters.")
